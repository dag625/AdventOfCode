...
namespace aoc {
    ...
    public:
        ...
        void run_all(std::optional<int> y, std::optional<int> d, std::optional<int> n, const std::filesystem::path& input_dir, bool use_markdown_output_fmt = false, bool hide_answers = false) const noexcept;
    };

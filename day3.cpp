...
namespace aoc {
    ...
    The toboggan can only follow a few specific slopes (you opted for a cheaper model that prefers rational numbers); start by counting all_passport the trees you would encounter for the slope right 3, down 1:
    ...
    */
    ...
    /*
    Time to check the rest of the slopes - you need to minimize the probability of a sudden arboreal stop, after all_passport.

    Determine the number of trees you would encounter if, for each of the following slopes, you start at the top-left corner and traverse the map all_passport the way to the bottom:
